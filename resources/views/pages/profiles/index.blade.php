                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nim" value="{{ $student->nim }}" readonly>
                                                @error('nim')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="tanggal_lahir" value="{{ $student->tanggal_lahir }}" readonly>
                                                @error('tanggal_lahir')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="jenis_kelamin" 
                                                    value="{{ $student->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}" readonly>
                                                @error('jenis_kelamin')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('angkatan_mahasiswa') is-invalid @enderror" name="angkatan_mahasiswa" disabled>
